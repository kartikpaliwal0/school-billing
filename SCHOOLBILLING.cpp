...
int main()
{
 ...
 printf("\n\n\n\n\n");
    ...
    system("color 6b");
    printf("\n\n\t** WELCOME TO C PROGRAM SCHOOL MANAGEMENT SYSTEM PROJECT **\n\n\n");
    for(i=0; i<80; i++)
    {
        printf("\xdb");
    }
    ...
    getch();
    system("cls");
    system("color 3E");//1st is for back ground color and second is for text color
